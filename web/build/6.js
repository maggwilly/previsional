...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__signup__ = __webpack_require__(931);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_text_mask__ = __webpack_require__(932);
        ...
        switch (this.stape) {
            ...
            case 'code':
                ...
                this.manager.post('token', code, 'check', true).then(function (data) {
                    ...
                    _this.manager.storeUser(data).then(function (user) {
                        console.log(data);
                        console.log(user);
...
var textMaskCore_1 = __webpack_require__(889);
...
var textMaskCore_2 = __webpack_require__(889);
